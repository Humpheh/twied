...
class TZPolyInterface:
    ...
    def get_polys(self, name, indicator):
        ...
        return proc_polystr(self.c.fetchall(), indicator.weight)

    def get_polys_offset(self, offset, indicator):
        self.c.execute(self.qstringoff, { 'offset': offset })
        return proc_polystr(self.c.fetchall(), indicator.weight)

    def get_polys_america(self, code, indicator):
